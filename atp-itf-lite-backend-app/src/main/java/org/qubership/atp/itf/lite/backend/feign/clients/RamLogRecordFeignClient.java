...
public interface RamLogRecordFeignClient {

    @RequestMapping(
            method = RequestMethod.GET,
            value = "/api/logrecords/{id}/contextVariables/all",
            produces = { "application/json" }
    )
    ResponseEntity<List<ContextVariableDto>> getAllContextVariables(@PathVariable("id") UUID id);
}
