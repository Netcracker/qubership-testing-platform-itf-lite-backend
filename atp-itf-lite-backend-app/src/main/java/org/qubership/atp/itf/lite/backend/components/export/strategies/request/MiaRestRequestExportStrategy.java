...
@Component
@Slf4j
public class MiaRestRequestExportStrategy extends MiaAbstractRequestExportStrategy {

    public MiaRestRequestExportStrategy(KafkaExportEventSendingService kafkaExportEventSendingService,
                                        RequestService requestService, ModelMapper modelMapper) {
    ...
    public void export(UUID exportRequestId, RequestExportRequest exportRequest, Request request, String context,
        ...
        sendExportRequestEvent(exportRequestId, (RequestMiaExportRequest) exportRequest, request, context);
    }
