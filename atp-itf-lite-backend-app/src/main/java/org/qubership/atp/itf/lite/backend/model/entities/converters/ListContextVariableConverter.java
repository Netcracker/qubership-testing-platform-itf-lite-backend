...
@NoArgsConstructor
@Slf4j
public class ListContextVariableConverter implements AttributeConverter<List<ContextVariable>, String> {

    private static final ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public String convertToDatabaseColumn(List<ContextVariable> requestParams) {
    ...
    @Override
    public List<ContextVariable> convertToEntityAttribute(String requestParamsJson) {
        List<ContextVariable> requestParams = null;
