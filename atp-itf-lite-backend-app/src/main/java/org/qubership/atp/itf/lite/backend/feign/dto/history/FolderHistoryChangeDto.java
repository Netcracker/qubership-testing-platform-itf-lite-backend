...
@JsonTypeName("FolderHistoryChange")
@Data
public class FolderHistoryChangeDto extends AbstractCompareEntityDto implements Serializable {
  ...
  public FolderHistoryChangeDto isAutoCookieDisabled(Boolean isAutoCookieDisabled) {
    this.isAutoCookieDisabled = isAutoCookieDisabled;
    return this;
  }

  public FolderHistoryChangeDto requests(List<String> requests) {
