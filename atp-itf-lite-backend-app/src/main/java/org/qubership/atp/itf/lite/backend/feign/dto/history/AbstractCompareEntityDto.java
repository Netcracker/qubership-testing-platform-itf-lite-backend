...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = FolderHistoryChangeDto.class, name = "FolderHistoryChange"),
...
@JsonTypeName("AbstractCompareEntity")
@Data
public class AbstractCompareEntityDto implements Serializable {
