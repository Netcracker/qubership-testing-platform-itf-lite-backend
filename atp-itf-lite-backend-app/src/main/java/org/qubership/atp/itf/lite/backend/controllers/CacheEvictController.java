...
import static org.qubership.atp.itf.lite.backend.model.api.ApiPath.CACHE_EVICT_PATH;
...
@RestController
@RequestMapping(SERVICE_API_V1_PATH + CACHE_EVICT_PATH)
@AllArgsConstructor
