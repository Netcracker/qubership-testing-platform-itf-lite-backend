...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "ITFL-1010")
public class ItfLiteImportRequestFileLoadException extends ItfLiteException {

    public static final String DEFAULT_MESSAGE = "Failed to load the file using the path: %s";

    public ItfLiteImportRequestFileLoadException(String path) {
