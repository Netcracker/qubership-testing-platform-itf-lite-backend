...
public interface CollectionRunStackRequestsRepository extends JpaRepository<CollectionRunStackRequest, UUID> {

    @Modifying
    @Transactional
    @Query("DELETE FROM CollectionRunStackRequest cr WHERE cr.createdWhen < :createdWhen")
