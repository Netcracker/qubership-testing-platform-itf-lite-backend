...
@AllArgsConstructor
@NoArgsConstructor
public class AuthorizationStrategyRequest {

    private AuthorizationSaveRequest safeAuthorizationRequest;
    private AuthorizationSaveRequest unsafeAuthorizationRequest;
    private AuthorizationResolvingContext authResolvingContext;
    private UUID projectId;
    private UUID environmentId;
    private Evaluator evaluator;
    private SaveRequestResolvingContext resolvingContext;
}
