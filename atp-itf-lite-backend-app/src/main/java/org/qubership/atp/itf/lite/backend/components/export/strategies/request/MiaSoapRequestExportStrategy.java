...
@Component
public class MiaSoapRequestExportStrategy extends MiaAbstractRequestExportStrategy {

    public MiaSoapRequestExportStrategy(KafkaExportEventSendingService kafkaExportEventSendingService,
