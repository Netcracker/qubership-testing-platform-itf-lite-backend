...
@Component
@Slf4j
public class ItfSoapRequestExportStrategy extends ItfAbstractRequestExportStrategy {

    private final RequestService requestService;

    public ItfSoapRequestExportStrategy(KafkaExportEventSendingService kafkaExportEventSendingService,
