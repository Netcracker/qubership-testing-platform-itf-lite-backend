...
@ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "ITFL-0008")
public class ItfLiteRequestIllegalAuthorizationGrantTypeException extends ItfLiteException {
