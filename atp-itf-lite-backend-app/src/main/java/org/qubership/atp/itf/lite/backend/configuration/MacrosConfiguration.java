...
@ComponentScan(basePackages = "org.qubership.atp.macros.core.converter")
public class MacrosConfiguration {

    private final MacrosFeignClient macrosFeignClient;

    @Bean(name = "macrosRepository")
    public MacrosRepository macrosRepository(MacrosDtoConvertService macrosDtoConvertService) {
        return new MacrosRepository(macrosFeignClient, macrosDtoConvertService);
    }
}
