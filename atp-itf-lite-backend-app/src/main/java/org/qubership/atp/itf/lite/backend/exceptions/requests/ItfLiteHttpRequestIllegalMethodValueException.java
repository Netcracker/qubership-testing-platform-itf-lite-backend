...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "ITFL-1003")
public class ItfLiteHttpRequestIllegalMethodValueException extends ItfLiteException {
