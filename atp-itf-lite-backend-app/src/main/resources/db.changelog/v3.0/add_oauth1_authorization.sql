...
DO $$
    BEGIN
        ...
        IF EXISTS (
            ...
            WHERE table_name = 'oauth1_request_authorizations' AND column_name = 'add_data_type'
        ) THEN
        ...
        IF EXISTS (
            SELECT 1 FROM information_schema.columns
            WHERE table_name = 'oauth1_request_authorizations' AND column_name = 'signature_method'
        ) THEN
            ALTER TABLE oauth1_request_authorizations
        ...
        IF EXISTS (
            SELECT 1 FROM information_schema.columns
            WHERE table_name = 'oauth1_request_authorizations' AND column_name = 'consumer_key'
        ) THEN
            ALTER TABLE oauth1_request_authorizations
        ...
        IF EXISTS (
            SELECT 1 FROM information_schema.columns
            WHERE table_name = 'oauth1_request_authorizations' AND column_name = 'consumer_secret'
        ) THEN
            ALTER TABLE oauth1_request_authorizations
